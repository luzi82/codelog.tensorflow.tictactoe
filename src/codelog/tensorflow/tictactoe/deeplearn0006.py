# clone of deeplearn 5
# force random move in some percent
...
def get_train_choice(state_ph,var_dict,mask):
...
class DeepLearn(object):
    ...
    def __init__(self):
        ...
        self.score, self.train_choice = get_train_choice(self.choice_state,self.var_dict,self.mask)
